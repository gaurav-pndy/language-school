  ...
  const documents = [
    {
      ...
      url: "/docs/ИНФОРМАЦИЯ О МЕДИЦИНСКОЙ ОРГАНИЗАЦИИ.pdf",
    },
    {
      id: 2,
      ...
      url: "/docs/Информация об адресах и номерах телефонов органа государственной власти субъекта Российской.pdf",
    },
    {
      id: 3,
      ...
      url: "/docs/Информация о страховых медицинских организациях, с которыми заключены договоры.pdf",
    },
    {
      id: 4,
      name: "ИНФОРМАЦИЯ О ПРАВАХ И ОБЯЗАННОСТЯХ ГРАЖДАН В СФЕРЕ ОХРАНЫ ЗДОРОВЬЯ",

      url: "/docs/Информация о правах и обязанностях граждан в сфере охраны здоровья.pdf",
    },
    {
      id: 5,
      ...
      url: "/docs/ИНФОРМАЦИЯ О НАЛИЧИИ ЛИЦЕНЗИИ НА ОСУЩЕСТВЛЕНИЕ МЕДИЦИНСКОЙ ДЕЯТЕЛЬНОСТИ, ЕЁ НОМЕРЕ, СРОКАХ ДЕЙСТВИЯ.pdf",
    },
    {
      id: 6,
      name: "Лицензия ООО Эйчди клиник",

      url: "/docs/Лицензия ООО Эйчди клиник.pdf",
    },
    {
      id: 7,
      ...
      url: "/docs/Информация о видах медицинской помощи, методах оказания медицинской.pdf",
    },
    {
      id: 8,
      ...
      url: "/docs/Информация о возможности получения медицинской помощи в.pdf",
    },
    {
      id: 9,
      ...
      url: "/docs/Информация о порядке, об объеме и условиях оказания медицинской.pdf",
    },
    {
      id: 10,
      ...
      url: "/docs/ИНФОРМАЦИЯ О ПОКАЗАТЕЛЯХ ДОСТУПНОСТИ И КАЧЕСТВА.pdf",
    },
    {
      id: 11,
      name: "Постановлении Правительства Москвы от 27.12.2024",

      url: "/docs/Постановлении Правительства Москвы от 27.12.2024.PDF",
    },
    {
      id: 12,
      ...
      url: "/docs/Информация о сроках, порядке, результатах проводимой.pdf",
    },
    {
      id: 13,
      name: "ИНФОРМАЦИЯ О ПРАВИЛАХ ЗАПИСИ НА ПЕРВИЧНЫЙ ПРИЕМ(КОНСУЛЬТАЦИЮ,ОБСЛЕДОВАНИЕ)",

      url: "/docs/Информация о правилах записи на первичный прием.pdf",
    },
    {
      id: 14,
      name: "ИНФОРМАЦИЯ О ПРАВИЛАХ ПОДГОТОВКИ К ДИАГНОСТИЧЕСКИМ ИССЛЕДОВАНИЯМ",

      url: "/docs/Информация о правилах подготовки к диагностическим исследованиям.pdf",
    },
    {
      id: 15,
      name: "ИНФОРМАЦИЯ О ПРАВИЛАХ И СРОКАХ ГОСПИТАЛИЗАЦИИ",

      url: "/docs/Информация о правилах и сроках госпитализации.pdf",
    },
    {
      id: 16,
      name: "ИНФОРМАЦИЯ О ПРАВИЛАХ ПРЕДОСТАВЛЕНИЯ ПЛАТНЫХ МЕДИЦИНСКИХ УСЛУГ",

      url: "/docs/Информация о правилах предоставления платных медицинских услуг.pdf",
    },
    {
      id: 17,
      ...
      url: "/docs/ИНФОРМАЦИЯ О ПЕРЕЧНЕ ОКАЗЫВАЕМЫХ ПЛАТНЫХ МЕДИЦИНСКИХ УСЛУГ, ОЦЕНАХ  (ТАРИФАХ) НА МЕДИЦИНСКИЕ УСЛУГИ.pdf",
    },
    {
      id: 18,
      ...
      url: "/docs/Сведения о медицинских работниках, участвующих в предоставлении.pdf",
    },
    {
      id: 19,
      name: "Информация О ВАКАНТНЫХ ДОЛЖНОСТЯХ ООО «Эйчди клиник»",

      url: "/docs/Информация О ВАКАНТНЫХ ДОЛЖНОСТЯХ ООО «Эйчди клиник».pdf",
    },
    {
      id: 20,
      ...
      url: "/docs/Информация о перечне жизненно необходимых и важнейших.pdf",
    },
    {
      id: 21,
      ...
      url: "/docs/Информация о перечне лекарственных препаратов, предназначенных.pdf",
    },
    {
      id: 22,
      ...
      url: "/docs/Информация о перечне лекарственных препаратов для медицинского применения.pdf",
    },
    {
      id: 23,
      ...
      url: "/docs/Информация о перечне лекарственных препаратов.pdf",
    },
    {
      id: 24,
      name: "Информация Об отзывах потребителей услуг",

      url: "/docs/Информация Об отзывах потребителей услуг.pdf",
    },
    {
      id: 25,
      name: "Политика в отношении обработки персональных данных",

      url: "/docs/Политика в отношении обработки персональных данных.pdf",
    },
    {
      id: 26,
      ...
      url: "/docs/информация о стандартах медицинской помощи и клинических рекомендациях.pdf",
    },
  ];
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          <div className="flex-1">
            ...
            <p className="text-lg md:text-xl max-w-2xl mx-auto text-center text-gray-500 mb-12">
              Documents confirming the right to carry out medical activities
            </p>
          </div>
        </div>
